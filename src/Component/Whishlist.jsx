            ...
            <main>
                <div id="Content">
                    <div className="product">
                        <div id="product0">
                        <img src="images/a1.png" height="160" width="150"/>
                ...
                <div id="Content">
                    <div className="product">
                        <div id="product1">
                        <img src="images/a2.png" height="150" width="200"/>
                ...
                <div id="Content">
                    <div className="product">
                        <div id="product2">
                        <img src="images/a3.png" height="150" width="200"/>
                        <h3>Green Cotton Shirt</h3>
                        <p>Type: Shirt</p>
                        <p>Price: 499</p>
                    </div>
                ...
                <div id="Content">
                    <div className="product">
                        <div id="product3">
                        <img src="images/a4.png" height="150" width="200"/>
