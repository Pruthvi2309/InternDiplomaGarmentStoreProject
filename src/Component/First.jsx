    ...
    return (
        <Wrapper>
            <nav className={`head ${mobileMenuOpen ? 'mobile-menu-open' : ''}`}>
                <div className='logo'>
                    <img src="./images/one.jpeg" className="img1" alt="Logo"/>
                </div>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        {showCausalWear && (
                                            <div className="nested-dropdown">
                                                <ul>
                                                    <li><NavLink to="/to" href="#">Top Wear</NavLink></li>
                                                    <li><NavLink to="/bo" href="#">Bottom Wear</NavLink></li>
                                                </ul>
                                            </div>
                                        )}
                                    </li>
                                    <li>
                                        ...
                                        {showPartyWear && (
                                            <div className="nested-dropdown">
                                                <ul>
                                                    <li><NavLink to="/Top" href="#">Top Wear</NavLink></li>
                                                    <li><NavLink to="/Bottom" href="#">Bottom Wear</NavLink></li>
                                                </ul>
                                            </div>
                                        )}
                                    </li>
