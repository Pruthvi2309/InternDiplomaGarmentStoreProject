    ...
    <div>
      <section className="about-section">
        <div className="container">
          ...
          <div className="text">
          In the near future, OneWay Garment Store envisions becoming a prominent and globally recognized fashion destination, setting new standards for high-quality and trendy clothing that caters to the diverse tastes and preferences of our cherished customers. Our ultimate aspiration is to establish a brand that epitomizes style.
              </div>
               <div className="text">
